...
response = requests.get('https://www.tripadvisor.com/Travel_Guide-g187779-Amalfi_Coast_Province_of_Salerno_Campania.html', headers=headers, cookies=cookies,verify=False)
